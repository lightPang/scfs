		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<form action="__APP__/Query/query_items" method="post">
						<div class="row">
						<!--
							<input type="hidden" name="checked[]" value="1"/>
							-->
							<?php if(is_array($head_data)): $i = 0; $__LIST__ = $head_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i;?><div >
									<input type="checkbox" class="ace" name="checked[]" value="<?php echo ($th["ctr_id"]); ?>"/>
									<span class="lbl"> <?php echo ($th["title"]); ?></span>
							...
							<!-- PAGE CONTENT BEGINS -->
								  ...
								  <div class="row">
									...
									<table class="table table-striped table-bordered table-hover" id="info_table">
									  <thead>
										<?php if(is_array($th_data)): $i = 0; $__LIST__ = $th_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><th><?php echo ($ta["title"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
									  </thead>
									  <tbody>
										 <?php if(is_array($body_data)): $i = 0; $__LIST__ = $body_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bd): $mod = ($i % 2 );++$i;?><tr>
										  <?php if(is_array($bd)): $i = 0; $__LIST__ = $bd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><td>
											<?php echo ($it["content"]); ?>
